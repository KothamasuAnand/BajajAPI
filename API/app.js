...
const user_id = "Kothamasu_Anand_05062002";
app.post('/bfhl', (req, res) => {
    try {
        const post_data = req.body;
        const collegeEmail = post_data.college_email || 'anand_kothamasu@srmap.edu.in';
        const collegeRollNumber = post_data.college_roll_number || 'AP20110010037';
